...
def read_image(customer, filename, save_path, timestamp, image):
    "Output: customer, filename, save_path, timestamp, image, thermal_image"
    ...
    return customer, filename, save_path, timestamp, image, thermal_image
